...
Q = eye(Nstate);%diag([1 5 0.1]);%_eye(Nstate);
R = 0.01*eye(Ncontrol);
P = Q;%eye(2);
...
Umax = [5 5];
Umin = [-5 -5];
Xmax = 480*ones(Nstate,1);%[200 200 200];
Xmin = -500*ones(Nstate,1);%[-200 -200 -200];
...
%%
name_file = ['regions_example2_kd_tree_mpt3_', num2str(N), '_v01.mat'];
